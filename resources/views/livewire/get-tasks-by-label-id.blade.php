<div class="ps-2" wire:poll.keep-alive>
    ...
    <div class="sticky">
        <div class="col d-flex ">
                ...
                <h6 class="card-title ms-2 mt-2 fontbrown inboxTitle"><strong class="me-2"> <a wire:navigate class="fontbrown" href="{{ URL::to('/') }}/labels">Label :</a> {{$label->label_name}}</strong>
                </h6>

<div class="px-5 py-4">
    <div class="row d-flex flex-wrap pt-3">
        <div id="account-details" class=" col-xl-6 col-lg-6 col-sm-8">
            ...
            <div class=" user-info mt-5 fontbrown">
                <form class="col" wire:submit="updateProfile">
                    <div class="mb-3">
                        <h6><label for="exampleInput1" class="form-label">Name</label></h6>
                        <input type="name" placeholder="Name" wire:model.live="user_name"
                            style="background: rgba(214, 214, 214, 0.377)" class="form-control" id="exampleInput1">
                        <span>
                            @error('user_name')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="mb-3 mt-4">
                        ...
                        <input type="email" placeholder="Email" wire:model.live="user_email"
                            class="form-control text-body-secondary " style="background: rgba(214, 214, 214, 0.377)"
        ...
        <div id="account-details" class=" col-xl-6 col-lg-6  col-sm-8 ">
            ...
            <div class=" user-info mt-5 fontbrown">
                <form class="col" wire:submit='changePassword'>
                    <div class="">
                        <h6><label for="exampleInput1" class="form-label">Current Password</label></h6>
                        <input wire:model.live='current_password' type="password" placeholder=" Current Password"
                            style="background: rgba(214, 214, 214, 0.377)" class="form-control" id="exampleInput1">
                        <span>
    ...
    <div class="col-md-12 col-sm-4 mt-5 ">
        <p class="fontbrown">!! This will immediately delete all of your data including tasks, projects, comments, and
            more. This can’t be undone !!</p>

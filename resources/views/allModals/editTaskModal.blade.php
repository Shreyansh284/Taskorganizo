            ...
            <div class="modal-body">
                <form wire:submit="updateTask">
                    ...
                    <div class="form-group">
                        <input wire:model.live="edit_task_name" type="text" class="form-control" id="recipient-name "
                    ...
                    <div class="form-group">
                        <textarea wire:model.live="edit_task_description" class="form-control" id="message-text" name="task_description"
                    ...
                    <div class="form-group">
                        <input wire:model.live="edit_due_date" type="date" class="form-control" id="recipient-name"
                    ...
                    <div wire:model.live="edit_projectId" class="form-group">
                    ...
                    <div class="form-group">
                        <select class="form-select" aria-label="Default select example" wire:model.live="edit_labelId">
                    ...
                    <div wire:model.live="edit_priority" class="form-group">
                        <select class="form-select" aria-label="Default select example" name="priority">
                            <option value="low">Choose Priority</option>
                            <option value="low" @if ($edit_priority == 'low') selected @endif name="priority">Low
                            </option>
                            <option value="medium" @if ($edit_priority == 'medium') selected @endif name="priority">
                                Medium</option>
                            <option value="high" @if ($edit_priority == 'high') selected @endif name="priority">
                                High</option>

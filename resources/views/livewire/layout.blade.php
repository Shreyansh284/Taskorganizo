            ...
            <div class="modal-body">
                <form method="POST" wire:submit="addTask">
                    ...
                    <div class="form-group">
                        <input wire:model="task_name" type="text" class="form-control" id="recipient-name "
                    ...
                    <div class="form-group">
                        ...
                        <textarea  wire:model="task_description"  class="form-control" id="message-text" name="task_description" placeholder="Task Description"></textarea>
                        <span>
                    ...
                    <div class="form-group">
                        ...
                        <input wire:model="due_date"  type="date" class="form-control" id="recipient-name" name="due_date"
                    ...
                    <div  wire:model="priority"  class="form-group">

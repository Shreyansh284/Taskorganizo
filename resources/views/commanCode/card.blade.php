<div class="card shadow border border-0 p-3">
    <div class="border-0 d-flex justify-content-between">
        <input type="checkbox" {{ $task->completed ? 'checked' : '' }} wire:click="toggleTaskStatus({{ $task->id }})"
    ...
    <div class="d-flex border-2  pt-2" style="border-top:dashed  rgb(165, 42, 42)">
        ...
        @if (isset($task->project_name))
            <a wire:navigate href="{{ URL::to('/') }}/project/{{ $task->project_name }}">

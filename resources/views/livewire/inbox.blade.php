<div class="ps-2">
    ...
    <div class="row mt-3 pt-3  " style="height: 77vh ;overflow-x:auto">
        @if($taskType=='today')
        <h5 class="card-title  mb-4  fontbrown" ><strong class="me-2">Today :</strong>{{ today()->format('j F, l')}}</h5>
        @elseif($taskType=='completed')
        <h5 class="card-title  mb-4  fontbrown" ><strong class="me-2">Completed Tasks :</strong></h5>
        @endif

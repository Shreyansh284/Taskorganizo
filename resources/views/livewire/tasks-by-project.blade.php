<div >
    ...
    {{-- <h5 class="card-title mt-5" style="color: brown"><strong>Today :</strong> {{$date}}</h5> --}}
    ...
    <div ><a data-bs-toggle="modal" data-bs-target="#addTask"  class="card-title  fw-semibold" style="font-size: 15px;  color:brown" ><i
